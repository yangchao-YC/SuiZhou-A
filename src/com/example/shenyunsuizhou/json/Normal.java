...
//	    	Toast.makeText(context.getApplicationContext(), "è¯·æ????¥ç??ç»?è¿????",Toast.LENGTH_LONG).show();
	    	return false;
    	}
//    	boolean wifi = con.getNetworkInfo(ConnectivityManager.TYPE_WIFI)
//	    	.isConnectedOrConnecting();
//	    	if (!wifi) {
//	    	Toast.makeText(context.getApplicationContext(), "å»ºè????¨ä½¿???WIFIä»¥å??å°?æµ????ï¼?",
